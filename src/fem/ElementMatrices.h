...
public:
    ...
    static Element::Matrix4 computeH(const Element& element,
        const Mesh& mesh,
        const UniversalElement& ue,
        double conductivity);

    //  Computes local capacity matrix C for one element
    static Element::Matrix4 computeC(const Element& element,
        const Mesh& mesh,
        const UniversalElement& ue,
        double density,
        double specificHeat);
...
private:
    ...
    static double computeRadiusAtGaussPoint(const Element& element,
        const Mesh& mesh,
        const UniversalElement& ue,
